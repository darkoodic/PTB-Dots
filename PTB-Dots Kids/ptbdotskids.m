...
function [] = kidANS()
    ...
    %% MAKE DATA FILE
    fn = strcat('Data/KidANS', '_', datestr(now, 'mmdd'),'_', sub,'.xls');
    fid = fopen(fn, 'a+');
    ...
    defaultArea = (rect(3)*rect(4))*0.015;
    ...
    %PILOT: 3.0, 2.0, 1.5, 1.25
    numberArray = [24,8; 8,24; 20,10; 10,20; 18,12; 12,18; 15,12; 12,15];
